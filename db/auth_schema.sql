...
-- =========================================================================
-- SEED DATA: Default admin user (phone: 9004464207, password: Candor@123*)
-- =========================================================================

INSERT INTO auth_user (phone, password_encrypted, full_name, role_id, is_active)
SELECT '9004464207',
       'gAAAAABpzNPRqdmZMRT5pU7mPFfKrFuwInT-Q3irPQ3jUTpgNtT4W-dZGBP-c64D4n-KTFy4l9B6Z3ZMq3wVOrhEeEeUBmyFAw==',
       'Admin', r.role_id, TRUE
FROM auth_role r WHERE r.role_name = 'admin'
