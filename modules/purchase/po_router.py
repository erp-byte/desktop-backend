...
Mounted in parallel to the legacy /api/v1/purchase/* router. This module:
    • Uses JWT-aware auth via `require_permission` from modules.auth.middleware
...
from modules.purchase.schemas.po_api import (
    CommitRequest,
    CommitResponse,
    PoDeleteResponse,
    PoDetailResponse,
...
from modules.purchase.services import po_commit, po_delete, po_preview, po_query
