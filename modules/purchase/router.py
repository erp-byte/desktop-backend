...
from modules.purchase.schemas import (
    POHeaderOut,
    POSummary,
    POViewResponse,
    POExportResponse,
...
from modules.purchase.services.ingest import ingest_po_book
from modules.purchase.services.queries import (
    build_where_clause,
    fetch_po_details,
)
            ...
            for section in body.sections:
                ...
                for b in section.boxes:
                    ...
                    """, b.box_id, sku_for_batch, transaction_no, b.lot_number,
                        po_date_for_batch, section.manufacturing_date, section.expiry_date,
