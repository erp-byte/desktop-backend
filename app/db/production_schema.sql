...
CREATE INDEX IF NOT EXISTS idx_jc_env_not_deleted ON job_card_environment(job_card_id) WHERE deleted_at IS NULL;
...
CREATE INDEX IF NOT EXISTS idx_jc_metal_not_deleted ON job_card_metal_detection(job_card_id) WHERE deleted_at IS NULL;
...
CREATE INDEX IF NOT EXISTS idx_jc_wc_not_deleted ON job_card_weight_check(job_card_id) WHERE deleted_at IS NULL;
...
CREATE INDEX IF NOT EXISTS idx_jc_loss_not_deleted ON job_card_loss_reconciliation(job_card_id) WHERE deleted_at IS NULL;
...
CREATE INDEX IF NOT EXISTS idx_jc_remarks_not_deleted ON job_card_remarks(job_card_id) WHERE deleted_at IS NULL;
