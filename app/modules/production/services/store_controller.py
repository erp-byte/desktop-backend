...
async def decide_allocation(conn, decisions: list[dict], decided_by: str,
    ...
    for d in decisions:
        ...
        await events.store_alert_created(entity, allocation_id=alloc['allocation_id'], decision=decision, material=alloc['material_sku_name'], approved_qty=float(approved_qty))
