...
async def flag_batch(conn, batch_id: str, reason: str, detail: str | None = None,
...
async def unblock_batch(conn, batch_id: str, performed_by: str, notes: str | None = None):
...
async def _cascade_indents_on_reassign(conn, batch, old_so_id, new_so_id, entity, performed_by):
    ...
    batch_qty = float(batch['current_qty_kg'])
    sku = batch['sku_name']
    result: dict[str, Any] = {"reduced_indent": None, "raised_indent": None}
...
async def issue_from_batch(conn, batch_id: str, qty_kg: float, *,
                           job_card_id: int | None = None, performed_by: str | None = None,
...
async def set_store_in_floor(conn, batch_id: str, performed_by: str | None = None):
...
async def check_shortfall(conn, sku_name: str, required_qty: float, entity: str, *,
                          so_id: int | None = None, job_card_id: int | None = None):
...
async def log_batch_rejection(conn, batch_id: str, rejected_by: str, reason_code: str,
                               reason_text: str | None = None, job_card_id: int | None = None,
                               so_id: int | None = None, entity: str | None = None):
...
async def return_batch(conn, batch_id: str, qty_kg: float, return_reason: str,
                       returned_by: str, destination_floor: str | None = None):
...
async def log_cascade_event(conn, batch_id: str, old_so_id: int, new_so_id: int,
                             old_indent_id: int | None = None, new_indent_id: int | None = None,
...
async def _log_legacy_import(conn, batch_id: str, item_code: str, imported_by: str,
                              source_file: str | None = None, entity: str | None = None):
    await conn.execute("""
...
async def list_internal_issues(conn, entity: str, status: str | None = None):
